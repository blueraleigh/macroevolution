...
static const R_CallMethodDef CallEntries[] = {
    ...
    CALLDEF(mkepoch_simulate, 4),

    CALLDEF(rcm_dmm_model_init, 8),
    CALLDEF(rcm_kmeans_counts_model_init, 7),
    ...
    CALLDEF(rcm_norm_model_init, 11),
    CALLDEF(rcm_norm_posterior_normal, 1),
